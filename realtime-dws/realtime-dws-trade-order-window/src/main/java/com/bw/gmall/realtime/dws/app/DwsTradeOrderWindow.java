...
public class DwsTradeOrderWindow extends BaseApp {
  ...
  @Override
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> stream) {
      SingleOutputStreamOperator<String> map = stream.map(JSONObject::parseObject)
      ...
      DataStreamSink<String> streamSink = map.sinkTo(FlinkSinkUtil.getDorisSink(Constant.DWS_TRADE_SKU_ORDER_WINDOW));
