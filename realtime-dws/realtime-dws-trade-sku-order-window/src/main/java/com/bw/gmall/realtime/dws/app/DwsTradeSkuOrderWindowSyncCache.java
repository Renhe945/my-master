package com.bw.gmall.realtime.dws.app;//package com.bw.gmall.realtime.dws.app;
//
//
//
////7）同步关联测试程序
...
//        new DwsTradeSkuOrderWindowSyncCache().start(Constant.TOPIC_DWD_TRADE_ORDER_DETAIL,"1",1,10030);
//
//    }
//
//    @Override
